<template lang="pug">
	admin-page(:schema="schema", :selected="selected", :rows="weblinks")
</template>
...
<script>
	...
	export default {
		...
		computed: mapGetters("admin_weblinks", [
			"weblinks",
			"selected"
		]),
