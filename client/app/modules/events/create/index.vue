		...
		el-row
			...
			el-col(:span="12", :offset="2")
				el-row
					...
					//- el-col(:span="10")
					//- 	.form-group(style="padding-top: 32px; margin-left: 12px;")
					//- 		button.button(@click="createBtnWeblink") Create New Weblink
		.form-group      
			button.button.warning(@click="onPickFile") Upload Image
			input(type="file", style="display: none", ref="fileInput", accept="image/*", @change="onFilePicked")
			img(:src="event.imageUrl", height="200")
		el-row         
			.block.text-right
				button.button.success(@click="createEvent") Create New Event
  ...
  methods: {
    ...
    onFilePicked(event) {
      ...
      fileReader.addEventListener("load", () => {
        this.event.imageUrl = fileReader.result;
      });
