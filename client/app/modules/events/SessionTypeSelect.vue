    ...
    <transition :name="transition">
      <ul ref="dropdownMenu" v-if="dropdownOpen" class="dropdown-menu" :style="{ 'max-height': maxHeight }">
        ...
        <li :class="{highlight:true}" @mouseover="typeAheadPointer = filteredOptions.length">
          ...
          <slot name="options">New SessionType</slot>
          </a>
        </li>
  ...
  methods: {
    ...
    select(option, event) {
      ...
      if (this.clicks === 1) {
        ...
        this.selectSessionType(option);
        clearTimeout(this.timer);
        this.clicks = 0;
        this.setSessionTypeDisplay(true);
      }
    },
    ...
    createnew() {
      //  this.selectWeblink(option);
      this.setSessionTypePopulate(this.search);
